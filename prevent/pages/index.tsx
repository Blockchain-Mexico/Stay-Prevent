import {Box, VStack, Text, ThemeProvider, theme, Collapse, IconButton} from "@chakra-ui/react";
...
function SloadTraceTreeItem(props: { showStorageChanges: Set<any>, node: TraceEntrySload, traceMetadata: TraceMetadata, children: JSX.Element[], traceResult: TraceResult, storageMetadata: StorageMetadata }) {
    return null;
}

function LogTraceTreeItem(props: { showStorageChanges: Set<any>, node: TraceEntryLog, traceMetadata: TraceMetadata, children: JSX.Element[], traceResult: TraceResult, storageMetadata: StorageMetadata }) {
    return null;
}

function TreeItem(props: { label: string, nodeId: string, children: ReactNode }) {
    return null;
}

function TreeView(props: { defaultCollapseIcon: JSX.Element, expanded: string[], onNodeToggle: (event: React.SyntheticEvent, nodeIds: string[]) => void, className: string, aria-label: string, defaultExpandIcon: JSX.Element, children: ReactNode }) {
    return null;
}
